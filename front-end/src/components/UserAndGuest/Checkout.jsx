...
export const displayProduct = (basket, hiddenButton = null, products) => {
    ...
    <div className={' mt-32 absolute w-full'}>
      ...
      >
        ...
        <div className={'flex justify-center'}>
          {basket.length > 0 ? (
            <div className="flex flex-col lg:mr-8 justify-center mt-20  xl:fixed top-36 right-0  items-center  p-2 m-2 border border-gray-300 shadow-md bg-white rounded-md max-w-sm">
              ...
              <div className="flex justify-end mt-4">
                <Link to={'/'}>
                  <button className="bg-blue-500  text-white px-1.5 py-2 rounded-md mr-4 hover:bg-blue-600">
                    Continue Shopping
                  </button>
                </Link>
                <Link to={'/payment'}>
