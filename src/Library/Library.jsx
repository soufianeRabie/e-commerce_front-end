...
export const GlobalColorTailwand = '-indigo-600'
export const Library = {
  ...
  setComplaints: (dispatch, complaints) => {
    dispatch({
      type: 'SET_COMPLAINTS',
      complaints,
    })
  },
  setDeliveries: (dispatch, deliveries) => {
    dispatch({
      type: 'SET_DELIVERIES',
      deliveries,
    })
  },
  setOnlineOrders: (dispatch, online_orders) => {
    dispatch({
      type: 'SET_ONLINE_ORDERS',
      online_orders,
    })
  },
}
